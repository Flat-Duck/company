    ...
    <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    <th class="text-left">
                        @lang('crud.sub_folders.inputs.name')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folders.inputs.main_folder_id')
                    </th>
                ...
                <tr>
                    ...
                    <td class="text-center" style="width: 134px;">
                        ...
                        >
                            ...
                            <a
                                href="{{ route('sub-folders.edit', $subFolder) }}"
                                class="btn btn-icon btn-outline-warinig ms-1"
                            >
                                <i class="ti ti-edit"></i>
                            </a>
                            @endcan @can('view', $subFolder)
                            <a
                                href="{{ route('sub-folders.show', $subFolder) }}"
