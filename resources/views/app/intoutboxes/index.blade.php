        ...
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.intoutboxes.inputs.main_folder_id')
                    </th>
                    <th class="text-left">
