<div>
    ...
    <x-modal id="sub-folder-memos-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.sub_folder_memos.inputs.number')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_memos.inputs.registered_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_memos.inputs.issued_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_memos.inputs.type')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_memos.inputs.subject')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_memos.inputs.main_folder_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
