<div>
    ...
    <x-modal id="sub-folder-extoutboxes-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="extoutbox.main_folder_id"
                            label="المجلد الرئيسي"
                            wire:model="extoutbox.main_folder_id"
                        >
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.number')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.registered_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.issued_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.sender')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.receiver')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.subject')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.company_status')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_folder_extoutboxes.inputs.main_folder_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="text-left">
                        {{ $extoutbox->registered_at->format('Y-d-m')?? '-' }}
                    </td>
                    <td class="text-left">
                        {{ $extoutbox->issued_at->format('Y-d-m') ?? '-' }}
                    </td>
                    ...
                    <td class="text-left">
                        {{ optional($extoutbox->mainFolder)->name ?? '-' }}
                    </td>
