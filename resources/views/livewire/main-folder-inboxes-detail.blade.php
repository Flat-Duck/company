<div>
    ...
    <x-modal id="main-folder-inboxes-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="inbox.sub_folder_id"
                            label="Sub Folder"
                            wire:model="inbox.sub_folder_id"
                        >
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.number')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.registered_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.issued_at')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.sender')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.receiver')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.subject')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.type')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.company_status')
                    </th>
                    <th class="text-left">
                        @lang('crud.main_folder_inboxes.inputs.sub_folder_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
