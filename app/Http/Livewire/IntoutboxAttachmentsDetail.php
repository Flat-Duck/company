...
class IntoutboxAttachmentsDetail extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function mount(Intoutbox $intoutbox): void
    {
    ...
    {
        $this->editing = false;
        $this->modalTitle = trans('crud.intoutbox_attachments.new_title');
        $this->resetAttachmentData();
    ...
    {
        $this->editing = true;
        $this->modalTitle = trans('crud.intoutbox_attachments.edit_title');
    ...
    public function save(): void
    {
        ...
        if (!$this->attachment->intoutbox_id) {
            $this->authorize('create', Attachment::class);

            $this->attachment->intoutbox_id = $this->intoutbox->id;
        } else {
    ...
    public function toggleFullSelection(): void
    {
        ...
        foreach ($this->intoutbox->attachments as $attachment) {
    ...
    {
        return view('livewire.intoutbox-attachments-detail', [
            'attachments' => $this->intoutbox->attachments()->paginate(20),
        ]);
    }
}
